...
echo "📋 Next steps:"
echo ""
echo "1️⃣  Create GitHub Release (if not done):"
echo "   - Go to: https://github.com/nile-agi/delta/releases/new"
echo "   - Tag: v$VERSION"
echo "   - Title: Delta CLI v$VERSION"
echo "   - Upload: $RELEASE_ZIP"
echo "   - Publish the release"
echo ""
echo "2️⃣  Fork winget-pkgs repository:"
echo "   - Go to: https://github.com/microsoft/winget-pkgs"
echo "   - Click 'Fork' button"
echo ""
echo "3️⃣  Clone your fork and submit:"
echo "   cd ~"
echo "   git clone https://github.com/YOUR_USERNAME/winget-pkgs.git"
echo "   cd winget-pkgs"
echo "   mkdir -p manifests/d/DeltaCLI/DeltaCLI/$VERSION"
echo "   cp $MANIFEST_PATH manifests/d/DeltaCLI/DeltaCLI/$VERSION/delta-cli.yaml"
echo "   git add manifests/d/DeltaCLI/DeltaCLI/$VERSION/"
echo "   git commit -m \"Add DeltaCLI.DeltaCLI version $VERSION\""
echo "   git push origin main"
echo ""
echo "4️⃣  Create Pull Request:"
echo "   - Go to: https://github.com/YOUR_USERNAME/winget-pkgs"
echo "   - Click 'Compare & pull request'"
echo "   - Submit the PR"
echo ""
echo "📖 For detailed instructions, see: packaging/winget/MACOS_GUIDE.md"
echo ""
