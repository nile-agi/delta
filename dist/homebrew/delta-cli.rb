...
class DeltaCli < Formula
  ...
  def install_from_source
    ...
    # Build web UI from app/ directory before building C++ code
    if Dir.exist?("web/app")
      ohai "Building web UI from web/app/..."
      cd "web/app" do
    ...
    %w[
      ...
      build/examples/server build/engine/vendor/llama.cpp/bin/server
    ].each do |p|
      if File.exist?(p)
        server_path = p
        break
    ...
    # Install web UI from public/ directory (built from app/)
